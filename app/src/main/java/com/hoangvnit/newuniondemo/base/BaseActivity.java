...
import com.hoangvnit.newuniondemo.mvp.citylist.CityListFragment;
import com.hoangvnit.newuniondemo.mvp.login.LoginFragment;
...
public class BaseActivity extends FragmentActivity {
    ...
    protected BaseFragment getFragment(FRAGMENT_ID id) {
        ...
        if (id == FRAGMENT_ID.CITY_LIST_FRAGMENT) {
            fragment = new CityListFragment();
        } else if (id == FRAGMENT_ID.LOGIN_FRAGMENT) {
